...
public class HelperController : MonoBehaviour
{
    ...
    [SerializeField] private List<GameObject> AssistiveArrows;
    [SerializeField] private List<AudioSource> IntroCluesAudio;
    [SerializeField] private List<AudioSource> TutorialCluesAudio;
    [SerializeField] private List<AudioSource> Zone1CluesAudio;
    [SerializeField] private List<AudioSource> Zone2CluesAudio;
    [SerializeField] private List<AudioSource> Zone3CluesAudio;
    [SerializeField] private List<AudioSource> Zone4CluesAudio;
    [SerializeField] private List<AudioSource> Zone5CluesAudio;
    ...
    private void ResetDialogue()
    {
        ...
        foreach (GameObject obj in AssistiveArrows)
        {
            obj.SetActive(false);
        }
    }
    public void ClueDisplay()
    {
        ...
        else if (zone5.mazeFinished)
        {
            ...
            PlaySingleAudio(ref Zone5CluesAudio, 1);
        ...
        else if (zone5.inZone)
        {
            ...
            PlaySingleAudio(ref Zone5CluesAudio, 0);
        ...
        else if (zone4.ghostDefeated)
        {
            ResetDialogue();
            Zone5Clues[2].SetActive(true);
            PlaySingleAudio(ref Zone5CluesAudio, 2);
            AssistiveArrows[4].SetActive(true);
            //Go towards the exit
        }
        else if (zone4.ghostWeakened)
        {
            ...
            PlaySingleAudio(ref Zone4CluesAudio, 2);
            //Capture the ghost
        }
        else if (false)
        {
            ...
            PlaySingleAudio(ref Zone4CluesAudio, 1);
        ...
        else if (zone4.inZone)
        {
            ...
            PlaySingleAudio(ref Zone4CluesAudio, 0);
            //Open up the chests with keys from previous zones
        }
        else if (zone3.keyObtained)
        {
            ResetDialogue();
            Zone4Clues[3].SetActive(true);
            PlaySingleAudio(ref Zone4CluesAudio, 3);
            AssistiveArrows[3].SetActive(true);
            //Go to zone 4
        }
        else if (zone3.ghostDefeated)
        {
            ...
            PlaySingleAudio(ref Zone3CluesAudio, 4);
        ...
        else if (false)
        {
            ...
            PlaySingleAudio(ref Zone3CluesAudio, 3);
        ...
        else if(zone3.mazeActive && zone3.planksObtained>0)
        {
            ...
            PlaySingleAudio(ref Zone3CluesAudio, 2);
        ...
        else if (zone3.mazeActive)
        {
            ...
            PlaySingleAudio(ref Zone3CluesAudio, 1);
            //Get the planks
        }
        else if(zone3.inZone)
        {
            ...
            PlaySingleAudio(ref Zone3CluesAudio, 0);
            //Start the pit section
        }
        else if (zone2.keyObtained)
        {
            ResetDialogue();
            Zone3Clues[5].SetActive(true);
            PlaySingleAudio(ref Zone3CluesAudio, 5);
            AssistiveArrows[2].SetActive(true);
            //Go to zone 3
        }
        else if(zone2.ghostDefeated)
        {
            ...
            PlaySingleAudio(ref Zone2CluesAudio, 4);
        ...
        else if(zone2.inZone && zone2.GhostStrength==0)
        {
            ...
            PlaySingleAudio(ref Zone2CluesAudio, 3);
            //Capture the ghost
        }
        else if(zone2.inZone && zone2.GhostStrength==1 && zone2.potionObtained)
        {
            ...
            PlaySingleAudio(ref Zone2CluesAudio, 2);
        ...
        else if (zone2.inZone && zone2.GhostStrength == 1 && zone2.bottleObtained)
        {
            ...
            PlaySingleAudio(ref Zone2CluesAudio, 1);
        ...
        else if (zone2.inZone && zone2.GhostStrength == 1)
        {
            ...
            PlaySingleAudio(ref Zone2CluesAudio, 0);
            //Get the correct bottle
        }
        else if(zone1.keyObtained)
        {
            ResetDialogue();
            Zone2Clues[5].SetActive(true);
            PlaySingleAudio(ref Zone2CluesAudio, 5);
            AssistiveArrows[1].SetActive(true);
            //Go to zone 2
        }
        else if(zone1.ghostDefeated)
        {
            ...
            PlaySingleAudio(ref Zone1CluesAudio, 3);
            //Get key
        }
        else if(zone1.torchLit)
        {
            ...
            PlaySingleAudio(ref Zone1CluesAudio, 2);
            //Capture ghost
        }
        else if(zone1.torchObtained)
        {
            ...
            PlaySingleAudio(ref Zone1CluesAudio, 1);
            //Light torch
        }
        else if(zone1.inZone)
        {
            ...
            PlaySingleAudio(ref Zone1CluesAudio, 0);
            //Grab torch from ground
        }
        else if(intro.polterdustObtained)
        {
            ResetDialogue();
            Zone1Clues[4].SetActive(true);
            PlaySingleAudio(ref Zone1CluesAudio, 4);
            AssistiveArrows[0].SetActive(true);
            //Go to zone 1
        }
        else if(intro.isDoorClosed)
        {
            if (!finishedTutorials[7] && !finishedTutorials[0])
            {
                ...
                PlaySingleAudio(ref TutorialCluesAudio, 0);
            ...
            } else
            {
                ...
                PlaySingleAudio(ref IntroCluesAudio, 1);
                //Get the polterdust
        ...
        else
        {
            ...
            PlaySingleAudio(ref IntroCluesAudio, 0);
            //Enter the building
        }
    }
    ...
    public void RunTutorial()
    {
        ...
        PlaySingleAudio(ref TutorialCluesAudio, tutorialNum);
    ...
    public void PlaySingleAudio(ref List<AudioSource> audios, int audioNum)
    {
